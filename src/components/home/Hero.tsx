    ...
    <section className="pt-32 pb-20 px-4">
      <div className="container mx-auto text-center section-animate">
        ...
        <p className="text-lg mb-12 max-w-3xl mx-auto">
          Vi är specialister inom Naturrestaureringsfördordningen (NRF), rewetting och Nature Restoration Law för restaurering av torvmarker och våtmarker i Mellansverige.
        </p>
